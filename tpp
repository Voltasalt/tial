...
if [ ! -f $ROM_FILE ] #Test if rom is already downloaded
    then
        ...
        #The shortned url points to https://www.loveroms.com/r/Gameboy Color/P-T/Pokemon - Red Version (UE)[!].zip
        #But i can't get it to work with all the spaces, etc. Some bash-wizz should fix it.
        zsh -c '
